...
<head>
    ...
    <title>View Categories - Vetri Velan Kaappi</title>
    ...
    <div class="table-box">
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($row['category_image']) { ?>
                            <img src="uploads/category/<?= $row['category_image'] ?>" class="cat-img">
                        <?php } else { echo "No Image"; } ?>
                    </td>

                    <td>
                        <a href="category-edit.php?id=<?= $row['category_id'] ?>" class="action-btn action-edit">
            ...
            while ($row = mysqli_fetch_assoc($sql)) { ?>
                <div class="card-row">
                    ...
                    <div class="card-item">
                        ...
                        <?php if ($row['category_image']) { ?>
                            <img src="uploads/category/<?= $row['category_image'] ?>" class="cat-img" style="margin-top:6px;">
                        <?php } else { echo "No Image"; } ?>
                    </div>
        ...
        <div class="pagination">
            ...
            <?php for ($p = 1; $p <= $total_pages; $p++): ?>
                <a href="?page=<?= $p ?>" class="page-number <?= ($p == $page ? 'active' : '') ?>">
                    <?= $p ?>
                </a>
            <?php endfor; ?>
