...
$query = mysqli_query($conn, "SELECT * FROM testimonials WHERE testimonial_id = $testimonial_id");
...
if (isset($_POST['update'])) {
    ...
    // Image handling
    $image = $data['image']; // default old image
    if (!empty($_POST['cropped_image'])) {
        ...
        // Delete old image
        $oldPath = "uploads/testimonials/" . $data['image'];
        if (file_exists($oldPath) && $data['image'] != "") {
            unlink($oldPath);
        }
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        $msg = "Error updating testimonial: " . mysqli_error($conn);
    }
}
?>
<!DOCTYPE html>
...
<title>Edit Testimonial - Vetri Velan Kaappi</title>
...
<div class="main">
    <div class="container-box">
        ...
        <div class="page-header">
            <h2><i class="fa-solid fa-star"></i> Edit Testimonial</h2>
            <p>Update customer testimonial details and image.</p>
        </div>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <?php if ($data['image'] != "") { ?>
                <img src="uploads/testimonials/<?= $data['image'] ?>" class="preview-img">
            ...
            <button type="submit" name="update" class="btn-submit">
                <i class="fa-solid fa-check"></i> Update Testimonial
            </button>
