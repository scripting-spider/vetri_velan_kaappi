...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header("Location: category-view.php?msg=success");
        exit;
    } else {
...
<title>Add Category - Vetri Velan Kaappi</title>
...
<div class="main">
    ...
    <div class="container-box">
        ...
        <div class="page-header">
            <h2><i class="fa-solid fa-folder-plus"></i> Add New Category</h2>
            <p>Use this form to create a new product category and upload a square image.</p>
        </div>
        ...
        <form method="POST">
            ...
            <!-- Image Upload -->
            <label><i class="fa-solid fa-image"></i> Category Image (Square Crop)</label>
